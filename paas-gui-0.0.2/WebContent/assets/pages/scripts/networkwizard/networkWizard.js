...
mycloudprovider.controller('MainCtrl', function ($scope,$http,$timeout) {
...
/*============ ServiceAffinities REG=============*/
    ...
    $scope.addNetworkDet = function() {
    	...
    	//console.log("vpc "+vpc);
  	  /*var res = $http.post('/paas-gui/rest/vpcService/addVPC', $scope.network.vpc);
  	...
  	var res = $http.post('/paas-gui/rest/environmentTypeService/insertEnvironmentType', $scope.network.environment);
	res.success(function(data, status, headers, config) {
		$scope.message = data;
	});
	res.error(function(data, status, headers, config) {
	  ...
	  var res = $http.post('/paas-gui/rest/aclService/addACLRule', $scope.network.acl);
	  res.success(function(data, status, headers, config) {
	  ...
	  res.error(function(data, status, headers, config) {
  	  ...
  	  var res = $http.post('/paas-gui/rest/subnetService/addSubnet', $scope.network.subnet);
  	  res.success(function(data, status, headers, config) {
    ...
    }; //	End of Add Network details method
