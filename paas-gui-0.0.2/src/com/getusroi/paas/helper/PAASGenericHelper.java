...
public class PAASGenericHelper {
	...
	public static String getIncrementValue(String value) {
	  ...
	  * @throws UnableToLoadPropertyFileException : Unable to read property file
	  */
	public synchronized static Properties getDockerHubPropertyFile(String fileName) throws UnableToLoadPropertyFileException{
		logger.debug(".getPropertyFile mehod of PAASGenericHelper");
		Properties prop=new Properties();
		try {
			prop.load(PAASGenericHelper.class.getClassLoader().getResourceAsStream(fileName));
	...
	public synchronized static Properties getScriptPropertyFile(String fileName) throws UnableToLoadPropertyFileException{
	 ...
	 /**
	  * This method is used to read properties file name supportConfig.properties
	  * @param supportConfigFile
	  * @return
	  * @throws UnableToLoadPropertyFileException
	  */
	public synchronized static Properties getSupportConfigPropertiesFile(String supportConfigFile) throws UnableToLoadPropertyFileException{
		logger.debug(".getSupportConfigPropertiesFile mehod of PAASGenericHelper");
		Properties prop=new Properties();
		try {
			prop.load(PAASGenericHelper.class.getClassLoader().getResourceAsStream(supportConfigFile));
			return prop;
		} catch (IOException e) {
			logger.error("Unable to load the property file"+supportConfigFile);
			throw new UnableToLoadPropertyFileException("Unable to load the property file"+supportConfigFile);
		}			
	}//end of method getPropertyFile
}
